...
export default function JobDetailsPage({ params }) {
    ...
    return (
        <div className="min-h-screen bg-[#ebdcc9]/10 px-4 md:px-8 py-6">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <button
                            onClick={() => router.back()}
                            className="group flex items-center gap-2 h-10 px-4 rounded-xl border border-[#dfcbaf] bg-white/50 backdrop-blur-md text-xs font-bold uppercase tracking-wider text-[#2c221e] transition-all hover:bg-[#2c221e] hover:text-[#ebdcc9] hover:border-[#2c221e] shadow-[4px_4px_10px_rgba(44,34,30,0.05),-4px_-4px_10px_rgba(255,255,255,0.1)] active:shadow-inner"
                        >
                        ...
                        <div className="rounded-[2.5rem] overflow-hidden border border-[#dfcbaf]/70 bg-white/50 backdrop-blur-md p-4 md:p-6 shadow-[12px_12px_30px_rgba(44,34,30,0.05),-12px_-12px_30px_rgba(255,255,255,0.1)] space-y-6">
                                ...
                                <div className="absolute top-4 left-4 right-4 flex items-center justify-between gap-4 z-10">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <button
                                            ...
                                            className={`flex items-center justify-center p-3 rounded-xl border backdrop-blur-md shadow-[4px_4px_10px_rgba(0,0,0,0.15)] transition-all duration-300 active:scale-95 ${isBookmarked
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center justify-center p-3 rounded-xl border backdrop-blur-md shadow-[4px_4px_10px_rgba(0,0,0,0.15)] transition-all duration-300 active:scale-95 ${isReported
                            ...
                            <div className="px-2 md:px-4">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
                                    <div className="flex flex-col gap-1 bg-[#2c221e]/5 p-4 rounded-2xl border border-[#dfcbaf]/20 shadow-inner">
                                ...
                                <div className="mt-8">
                                    ...
                                    <p className="text-[#4a3b35] text-sm leading-relaxed font-medium whitespace-pre-line bg-white/40 p-5 rounded-2xl border border-[#dfcbaf]/30 shadow-inner">
                                        {job.description}
                                    </p>
                                </div>

                                <div className="mt-5 rounded-2xl border border-[#dfcbaf] bg-gradient-to-r from-[#2c221e] to-[#4a3b35] p-5 text-[#ebdcc9] shadow-lg">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className="text-[11px] uppercase tracking-widest opacity-80">
                                                Total Applications
                                            </p>
                                            <h2 className="text-3xl font-black mt-1 text-red-500">
                                                {job.applicants.length}
                                            </h2>
                                            <p className="text-xs opacity-70 mt-1">
                                                Candidates have already applied
                                            </p>
                                        </div>

                                        <div className="w-14 h-14 rounded-2xl bg-[#ebdcc9]/20 flex items-center justify-center shadow-md">
                                            <UsersRound size={28} />
                                        </div>
                                    </div>
                                </div>
                    ...
                    {/* Right Layout */}
                    <div className="space-y-6 lg:sticky lg:top-6 lg:mt-14">
                        <div className="rounded-[2.5rem] border border-[#dfcbaf] bg-white/40 p-6 shadow-[12px_12px_30px_rgba(44,34,30,0.04)] flex flex-col items-center text-center relative overflow-hidden">
                        ...
                        <div className="rounded-[2.5rem] border border-[#dfcbaf]/70 bg-white/70 backdrop-blur-md p-6 shadow-[12px_12px_30px_rgba(44,34,30,0.05),-12px_-12px_30px_rgba(255,255,255,0.9)] space-y-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center justify-between text-xs font-bold border-b border-[#dfcbaf]/20 pb-2">
                                    ...
                                    <span className="text-emerald-600 truncate max-w-[150px]">{job.userEmail}</span>
                                </div>
                                <div className="flex items-center justify-between text-xs font-bold">
                                    <span className="text-[#4a3b35]/70 flex items-center gap-1.5"><IdCard size={13} /> Job ID </span>
                                    <span className="text-[#4a3b35] font-mono text-[11px] select-all">{job._id}</span>
                                </div>
                            </div>
                        </div>
                    </div>
