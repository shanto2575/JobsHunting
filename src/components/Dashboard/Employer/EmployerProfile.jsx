        ...
        <div className="w-full rounded-3xl border border-[#dfcbaf] bg-white/30 backdrop-blur-xl p-6 shadow-[0_20px_40px_-15px_rgba(44,34,30,0.08)]">
            ...
            <div className="flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between">
                ...
                <Link
                    ...
                    className="px-5 py-3 rounded-xl bg-[#2c221e] text-[#ebdcc9] font-semibold text-sm hover:opacity-90 transition-all border border-[#2c221e]"
                >
                    Edit Profile
                </Link>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-8">
                ...
                <div className="rounded-2xl bg-[#ebdcc9]/60 p-4 border border-[#dfcbaf]">
                    <div className="flex items-center gap-2 mb-2 py-4">
                        <FileText size={18} className="text-[#2c221e]" />
                        <h4 className="font-semibold text-[#2c221e] text-2xl">
                            Jobs Published
                        </h4>
                    </div>
                ...
                {/* Applications */}
                <div className="rounded-2xl bg-[#ebdcc9]/60 p-4 border border-[#dfcbaf]">
                    <div className="flex items-center gap-2 mb-2 text-2xl py-4">
                        <Briefcase size={18} className="text-[#2c221e]" />
                        <h4 className="font-semibold text-[#2c221e]">
                            Applications
                        </h4>
                    </div>
                ...
                <div className="rounded-2xl bg-[#ebdcc9]/60 p-4 border border-[#dfcbaf]">
                    <div className="flex items-center gap-2 mb-2">
                        <Bookmark size={18} className="text-[#2c221e]" />
                        <h4 className="font-semibold text-[#2c221e]">
                            Saved Jobs
                        </h4>
                    </div>
                ...
                {user?.plan === "free" ? (
                    <>
                        ...
                        <p className="text-sm opacity-90 leading-relaxed">
                            Upgrade to Pro and unlock premium job visibility,
                            advanced analytics, unlimited applications, and
                    ...
                    <>
                        ...
                        <p className="text-sm opacity-90 leading-relaxed">
                            You are enjoying premium features including
                            highlighted jobs, better reach, advanced analytics,
